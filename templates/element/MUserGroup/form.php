...
<?= $this->Form->create($mUserGroup, ['type' => 'file']) ?>
    <div class="titlebox">
            <p1><?= $mode === 'edit' ? '施設グループ編集' : '施設グループ登録' ?></p1>
    </div>
<div class="flex-vertical">
            ...
            <?= $this->Form->control('user_group_id', [
                ...
                'value' => $mUserGroup->user_group_id, // ←addは＋1済、editは既存値
            ...
            <?= $this->Form->control('user_group_name', [
                    'label' => false,
                    'id' => 'user_group_name',
                ]) ?>
            </div>
