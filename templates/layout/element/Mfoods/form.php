...
<div class="flex-vertical">
            ...
            <?= $this->Form->control('food_specification', [
                ...
                'value' => $mfood->food_specification,
            ]) ?>
            </div>
            ...
            <?= $this->Form->control('user_group_id', [
                ...
                'options' => $mUserGroup,
                'empty' => '選択',
                'value' => $selectedGroupId,//ここで初期値をセット
                ...
                <table class="intable">
                    ...
                    <?php if ($mode === 'add'): ?>
                        <?php foreach ($mUser as $userId => $userName): ?>
                            ...
                            ?>
                            <?php if ((string)$userGroupPrefix === (string)$selectedGroupId): ?>
                                <tr>
                                    <td>
                    ...
                    <?php endif; ?>
                        ...
                        <?php if ($mode === 'edit'): ?>
                            <?php foreach ($mUser as $userId => $userName): ?>
                                <?php if (in_array($userId, $selectedUserIds ?? [])): ?>
                                    <tr>
                                        <td>
                                            <?= $this->Form->control("selected_users[{$userId}]", [
                                                'type' => 'checkbox',
