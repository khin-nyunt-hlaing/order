...
/**
 * MDeliveryPattern Entity
 *
 * @property int|null $use_pattern_id
 * @property string|null $delivery_pattern_name
 ...
 */
class MDeliveryPattern extends Entity
{
    /**
